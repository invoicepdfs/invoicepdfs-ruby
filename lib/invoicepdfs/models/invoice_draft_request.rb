...
module InvoicePDFs
  class InvoiceDraftRequest
    ...
    def hash
      [invoice_number, document_type, issue_date, due_date, currency, locale, business_profile_id, customer_id, ship_to, buyer_reference, tax_scheme, delivery_date, preceding_invoice_number, line_items, discounts, shipping, notes, terms, custom_fields, payment, branding].hash
    end
