...
module InvoicePDFs
  class TemplateVersionsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [TemplateVersionResponse]
    def restore_template_version(template_id, version, opts = {})
      data, _status_code, _headers = restore_template_version_with_http_info(template_id, version, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(TemplateVersionResponse, Integer, Hash)>] TemplateVersionResponse data, response status code and response headers
    def restore_template_version_with_http_info(template_id, version, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: TemplateVersionsApi.restore_template_version ...'
      end
      # verify the required parameter 'template_id' is set
      if @api_client.config.client_side_validation && template_id.nil?
        fail ArgumentError, "Missing the required parameter 'template_id' when calling TemplateVersionsApi.restore_template_version"
      end
      # verify the required parameter 'version' is set
      if @api_client.config.client_side_validation && version.nil?
        fail ArgumentError, "Missing the required parameter 'version' when calling TemplateVersionsApi.restore_template_version"
      end
      # resource path
      local_var_path = '/api/v1/templates/{template_id}/versions/{version}/restore'.sub('{' + 'template_id' + '}', CGI.escape(template_id.to_s)).sub('{' + 'version' + '}', CGI.escape(version.to_s))
      ...
      new_options = opts.merge(
        :operation => :"TemplateVersionsApi.restore_template_version",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: TemplateVersionsApi#restore_template_version\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
