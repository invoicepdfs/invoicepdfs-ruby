...
module InvoicePDFs
  class TemplatesApi
    ...
    # @return [Object]
    def preview_template_api_v1_templates_template_id_preview_post(template_id, document_render_request, opts = {})
      data, _status_code, _headers = preview_template_api_v1_templates_template_id_preview_post_with_http_info(template_id, document_render_request, opts)
      data
    end
    ...
    def preview_template_api_v1_templates_template_id_preview_post_with_http_info(template_id, document_render_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && document_render_request.nil?
        fail ArgumentError, "Missing the required parameter 'document_render_request' when calling TemplatesApi.preview_template_api_v1_templates_template_id_preview_post"
      end
      # resource path
