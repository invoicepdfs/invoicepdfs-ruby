...
# Unit tests for InvoicePDFs::DocumentCreateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InvoicePDFs::DocumentCreateRequest do
  let(:instance) { InvoicePDFs::DocumentCreateRequest.new }

  describe 'test an instance of DocumentCreateRequest' do
    it 'should create an instance of DocumentCreateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InvoicePDFs::DocumentCreateRequest)
    end
  end
  ...
  describe 'test attribute "branding_profile_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
