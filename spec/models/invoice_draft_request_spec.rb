...
# Unit tests for InvoicePDFs::InvoiceDraftRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InvoicePDFs::InvoiceDraftRequest do
  let(:instance) { InvoicePDFs::InvoiceDraftRequest.new }

  describe 'test an instance of InvoiceDraftRequest' do
    it 'should create an instance of InvoiceDraftRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InvoicePDFs::InvoiceDraftRequest)
    end
  end
