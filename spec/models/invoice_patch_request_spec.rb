...
# Unit tests for InvoicePDFs::InvoicePatchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe InvoicePDFs::InvoicePatchRequest do
  let(:instance) { InvoicePDFs::InvoicePatchRequest.new }

  describe 'test an instance of InvoicePatchRequest' do
    it 'should create an instance of InvoicePatchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(InvoicePDFs::InvoicePatchRequest)
    end
  end
